...
function datosUsuario(nick,generoAnimeTexto,generoRomanceTexto,generoKDramaTexto){
    ...
    sessionStorage.setItem('generoAnime', generoAnimeTexto);
    sessionStorage.setItem('generoRomance', generoRomanceTexto);
    sessionStorage.setItem('generoKDrama', generoKDramaTexto);
}
